...
const en = {
  ...
  "account.fields.avatarPlaceholder": "Image URL, or upload →",
  "account.fields.upload": "Upload",
  "account.fields.uploaded": "Image uploaded — tap to clear",
