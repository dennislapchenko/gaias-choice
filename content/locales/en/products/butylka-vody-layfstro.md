...
boughtAt: "Centralais Turgus"  # optional — where we got it (store/place); splits the price panel in two
...
tags: [water filter, lifestraw, travel]
---
...
ten seconds. Would you buy the LifeStraw bottle again — knowing what you know now?

## Why a filtering bottle went into the camper
...
## How the LifeStraw bottle traveled with us
...
## Where the bottle earned its place
...
## What we'd change about the bottle
...
## Who the LifeStraw bottle is for
