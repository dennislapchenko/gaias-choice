...
polyester feeling, no overheating.

## Why it earns its place

- **Material** — 100% merino, no synthetic fill, no fragrance finish.
- **Range** — genuinely comfortable across a wide band of temperatures, so it's
  the one sleep layer we pack instead of three.
...
> Warm when it's cold, cool when it's warm. One layer, far fewer packing decisions.
