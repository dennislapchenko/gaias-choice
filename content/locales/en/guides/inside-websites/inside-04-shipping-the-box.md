...
> **Chapter 4 of 5 · The Path** — [← Chapter 3: The Living Page](/guides/inside-03-the-living-page) · [Chapter 5: Owning the Stack →](/guides/inside-05-owning-the-stack)
...
`/guides/inside-03-the-living-page` into a fresh tab. The browser sends
that path to the server. The server has **the bundle** — `index.html`,
`assets/`, images. There is no file called
`guides/inside-03-the-living-page` in it. Every static host in the world
...
3. Test the seed from chapter 3:
   `curl -i http://localhost:8080/guides/inside-01-the-whole-machine` —
...
**[Chapter 5: Owning the Stack →](/guides/inside-05-owning-the-stack)**
