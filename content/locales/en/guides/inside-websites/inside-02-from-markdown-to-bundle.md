...
> **Chapter 2 of 5 · The Path** — [← Chapter 1: The Whole Machine](/guides/inside-01-the-whole-machine) · [Chapter 3: The Living Page →](/guides/inside-03-the-living-page)
...
The same pattern pulls in guides (`guides/**/*.md`), pages, `site.yaml`,
...
`content/locales/en/guides/inside-websites/inside-02-from-markdown-to-bundle.md`.
At build time the guides glob vacuumed it in as a string. `parseFrontmatter`
...
**[Chapter 3: The Living Page →](/guides/inside-03-the-living-page)**
