...
The thinking behind each phase lives in our
[founder guides](/guides), starting with the
[Kickstart Playbook](/guides/kickstart-playbook).
...
**Exit criteria:** a stranger could read any page without being misled.

## Phase 1 — Real content *(next ~2 months)*

**Goal: 10 real reviews, zero placeholders.**

- [ ] First real review published (own product, own photos, honest flaws)
- [ ] All placeholder reviews and images deleted or replaced
- [ ] 10 reviews + 3 reader-facing guides live
...
- [ ] Privacy-friendly analytics (cookieless, no consent banner needed)
...
- [ ] Email capture live (self-hosted newsletter service is on the dev track)
- [ ] First free printable checklist as the signup magnet
- [ ] Monthly metrics review habit (Search Console queries → content list)

**Milestone:** 1,000 organic visits/month.
...
- [ ] Apply to affiliate programs — brands we've already reviewed first,
      ...
      days — see [the money guide](/guides/how-this-site-will-make-money))*
...
**Milestone:** first commission. Frame it. Then: consistent $100/month.

## Phase 4 — Compounding *(year 1+)*

Only opened once Phase 3 milestones are real:

- [ ] Paid printable bundles (checklists, packing lists)
...
- [ ] Replace these founder guides with reader-facing content; archive them
      in a "building in public" corner if we're feeling sentimental
