...
const ru: Record<keyof typeof en, string> = {
  ...
  // См. compass.provenanceLabel в en.ts — та же оговорка, но в одну строку,
  ...
  "account.stats.frontend": "Фронтенд",
  "account.stats.api": "API",
  "account.stats.path": "Адрес",
  "account.stats.hits": "Очки",
  ...
  "editor.published": "Опубликовано — на сайте через ~1 мин",
  "editor.publishing": "Публикуем… на сайте через ~1 мин",
  ...
  "editor.field.price": "Цена",
  "editor.field.boughtAt": "Где взяли",
  "editor.field.affiliateUrl": "Партнёрская ссылка",
  "editor.field.image": "Картинка",
  "editor.field.tags": "Теги",
  "editor.field.state": "Статус",
  "editor.field.excerpt": "Описание",
  "editor.field.date": "Дата",
  "editor.field.translatedFrom": "Переведено с",
