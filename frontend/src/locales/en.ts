...
const en = {
  ...
  "account.stats.frontend": "Frontend",
  "account.stats.api": "API",
  "account.stats.path": "Path",
  "account.stats.hits": "Hits",
  ...
  "editor.published": "Published — live in ~1 min",
  "editor.publishing": "Publishing… live in ~1 min",
  ...
  "editor.discardConfirm": "Close the editor? Your edits are kept as a draft and restored next time.",
  "editor.draftRestored": "Restored your unsaved draft.",
  "editor.draftDiscard": "Discard it",
  "editor.createTitle": "Queue a new post",
  "editor.createSubmit": "Create draft",
  ...
  "editor.field.price": "Price",
  "editor.field.boughtAt": "Where we got it",
  "editor.field.affiliateUrl": "Affiliate URL",
  "editor.field.image": "Image",
  "editor.field.tags": "Tags",
  "editor.field.state": "State",
  "editor.field.excerpt": "Excerpt",
  "editor.field.date": "Date",
  "editor.field.translatedFrom": "Translated from",
  "editor.mdBold": "Bold",
  ...
  "imageFrame.hintMove": "Drag to move",
  "imageFrame.hintZoom": "Pinch or scroll to zoom",
